...
*/
  ...
  /**
   * Simula el click de un boton.
   * Simulates a click of a button.
   * @author xcitizen.team@gmail.com (José Mª Martín)
   */
   
  @SimpleFunction(description = "Simula la pulsación del boton menu" + "/" + "Simulates a click button menu")
  public void SimulateMenuClickButton() {
    EventDispatcher.dispatchEvent(this, "OnMenuKey");
  }

   @SimpleFunction(description = "Simula la pulsación del botón buscar" + "/" + "Simulates a click button Search")
  public void SimulateSearchClickButton() {
    EventDispatcher.dispatchEvent(this, "OnSearchKey");
  }

   @SimpleFunction(description = "Simula la pulsación del botón atras" + "/" + "Simulates a click button back")
  public void SimulateBackClickButton() {
    EventDispatcher.dispatchEvent(this, "BackPressed");
  }

   @SimpleFunction(description = "Simula la pulsación del botón subir volumen" + "/" + "Simulates a click button Volume Up")
  public void SimulateVolumeupClickButton() {
    EventDispatcher.dispatchEvent(this, "OnVolumeupKey");
  }

   @SimpleFunction(description = "Simula la pulsación del botón bajar volumen" + "/" + "Simulates a click button Volume Down")
  public void SimulateVolumedownClickButton() {
    EventDispatcher.dispatchEvent(this, "OnVolumedownKey");
  }
...
*/
  ...
  // Add ScreenCapture xcitizen.team@gmail.com
  ...
  @DesignerProperty(editorType = PropertyTypeConstants.PROPERTY_TYPE_ASSET,
      defaultValue = "")
  @SimpleProperty
  public void CaptureSaveAs(String path) {
    SaveCapture = (path == null) ? "" : path;
 }
  ...
  private void SC(View view){
        ...
        File f = new File(sd, SaveCapture);
        try {
            if (sd.canWrite()) {
                 f.createNewFile();
        ...
        //                "Captura realizada con exito", Toast.LENGTH_SHORT);
