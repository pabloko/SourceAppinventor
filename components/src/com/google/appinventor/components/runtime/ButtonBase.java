...
public abstract class ButtonBase extends AndroidViewComponent
   ...
   *
   * @param typeFace  type uploaded typeface file
   */
  @DesignerProperty(editorType = PropertyTypeConstants.PROPERTY_TYPE_ASSET,
      defaultValue = "")
  @SimpleProperty
...
//    try {
//      String foo = findCaseinsensitivePath(container.$form(), typeFace);
//    AssetManager assetManager = view.getContext().getAssets();
//      Typeface tf = Typeface.createFromAsset(assetManager, typeFace);
////      if (tf == null) {
////        Log.d(LOG_TAG, "empty font asset or not found 2 " + typeFace);
////        return;
////      }
//
//      view.setTypeface(tf);
//      this.typefaceFileName = typeFace;
//      TextViewUtil.setFontTypeface(view, fontTypeface, bold, italic);
//      Log.d(LOG_TAG, "font asset is now done " + typeFace);
//
//      Log.d(LOG_TAG, "font asset set to  " + typeFace);
//    } catch (IOException e) {
