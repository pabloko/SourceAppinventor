 ...
 */
@SimpleObject
public final class VerticalScrollView implements Layout {
   ...
   */
  VerticalScrollView(Context context) {
   ...
   */
  VerticalScrollView(Context context, final Integer preferredEmptyWidth, final Integer preferredEmptyHeight) {
