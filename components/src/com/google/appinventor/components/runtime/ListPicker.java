...
//
//  @DesignerProperty(editorType = PropertyTypeConstants.PROPERTY_TYPE_SORT_OPTIONS,
//      defaultValue = "0") //0 means no sorting
//  @SimpleProperty(description = "Allows you to specify a sort order for the ListPicker. " +
//      "The ListPicker can be sorted in Ascending(1), Descending(2) or None(0) ")
//  public void SortOrder(int value) {
//    items = YailList.makeList(items.toStringArray(), value);
//
//  }

  @SimpleProperty(description = "Returns the ListPicker SortOrder",
      category = PropertyCategory.BEHAVIOR)
  ...
  @DesignerProperty(editorType = PropertyTypeConstants.PROPERTY_TYPE_BOOLEAN,
      defaultValue = "false") //0 means no sorting
  @SimpleProperty
  public void ShowFilterBar(boolean showFilter) {
    this.showFilter = showFilter;
  }

  @SimpleProperty(description = "Returns current state of ShowFilterBar indicating if " +
