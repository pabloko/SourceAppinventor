...
public class ContactPicker extends Picker implements ActivityResultListener {
  ...
  private final int CONTACT_PICKER_RESULT = 898; // ADD xcitizen.team@gmail.com
...
//    }
  ...
  /* 
  *  EXPERIMENTAL xcitizen.team@gmail.com
  *   Add Agenda, Read Agenda
  */
    	...
    	if (cur.getCount() > 0) {
        	while (cur.moveToNext()) {
        		...
        		if (existName.contains(name)) {
                	//Toast.makeText(ContactPicker.this,"The contact name: " + name + " already exists", Toast.LENGTH_SHORT).show();
			Toast toast = Toast.makeText(activityContext, name, Toast.LENGTH_LONG);
    			...
    			textView.setText("The contact name: " + name + " already exists");
  ...
  Toast.makeText(activityContext, "Created a new contact with name: " + name + " and Phone No: " + phone, Toast.LENGTH_LONG).show();
    			//Toast toast = Toast.makeText(activityContext, name, Toast.LENGTH_LONG);
    			//toast.setGravity(Gravity.CENTER, toast.getXOffset() / 2, toast.getYOffset() / 2);
    			//TextView textView = new TextView(activityContext);
    			//textView.setBackgroundColor(Color.DKGRAY);
    			...
    			//textView.setTypeface(typeface);
    			//textView.setPadding(10, 10, 10, 10);
    			//textView.setText("Created a new contact with name: " + name);
    			//toast.setView(textView);
    			//toast.show();
    }
        	...
        	while (cur.moveToNext()) {
        		...
        		if (Integer.parseInt(cur.getString(
                     ...
                     while (pCur.moveToNext()) {
                    	 ...
                    	 Toast.makeText(activityContext, "Name: " + name + ", Phone No: " + phoneNo, Toast.LENGTH_SHORT).show();
                     } 
      	        pCur.close();
      	    }
        	}
