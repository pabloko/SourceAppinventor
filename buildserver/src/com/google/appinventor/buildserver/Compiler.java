  ...
  private boolean writeAndroidManifest(File manifestFile, Set<String> permissionsNeeded) {
    ...
    try {
      ...
      out.write("<supports-screens " +
                "android:xlargeScreens=\"true\" " + "android:largeScreens=\"true\" " + "android:normalScreens=\"true\" " +
	  ...
	  String FeaturedTargetSdk = "";
        ...
        if (componentTypes.contains("ContactPicker")) {
	    FeaturedMinSdk = "8"; 
	  }  
	...
	out.write("<permission android:name=\"" + packageName + ".permission.C2D_MESSAGE\" android:protectionLevel=\"signature\" /> \n" +
	  ...
	  if (componentTypes.contains("AdMob") || componentTypes.contains("AdMobIntersitial")) {
	    FeaturedMinSdk = "9";
		FeaturedTargetSdk = "18";
	  } 
	...
	//
	  ...
	  */
      ...
      /*
      //fullscreen+notitlebar
      if (componentTypes.contains("FullScreen")) {
      out.write("android:theme=\"@android:style/Theme.NoTitleBar.Fullscreen\" ");
      }
      //notitlebar
      if (!componentTypes.contains("FullScreen") && componentTypes.contains("NoTitleBar")) {
          out.write("android:theme=\"@android:style/Theme.NoTitleBar\" ");
      }*/
      
      String thetheme = "Theme";
      String tdark=".Black";
      String tabar=".NoTitleBar";
      
      if (componentTypes.contains("Holo")) {
    	  thetheme = thetheme+".Holo";
    	  tdark="";
    	  tabar=".NoActionBar";
      } 
      
      if (componentTypes.contains("ThemeLight") && !componentTypes.contains("ThemeDark")) {
    	  thetheme = thetheme+".Light";
      }
      
      if (componentTypes.contains("ThemeDark") && !componentTypes.contains("ThemeLight")) {
    	  thetheme = thetheme+tdark;
      }
      
      if (!componentTypes.contains("FullScreen") && componentTypes.contains("NoTitleBar")) {
    	  thetheme = thetheme+tabar;
      }
      
      if (componentTypes.contains("FullScreen") && !componentTypes.contains("NoTitleBar")) {
    	  thetheme = thetheme+tabar+".Fullscreen";
      }
      
      if (thetheme!="Theme") {
    	  out.write("android:theme=\"@android:style/"+thetheme+"\" ");
      }
	  ...
	  //HUPDATE
      if (componentTypes.contains("AdMob") || componentTypes.contains("AdMobIntersitial")) {
    	  out.write("<meta-data android:name=\"com.google.android.gms.version\" android:value=\"4030500\" />");
      }
	  /*@ Jose María Martin*/
	  if (componentTypes.contains("AdMob") || componentTypes.contains("AdMobIntersitial")) {
		  //HUPDATE
        ...
        out.write("<activity android:name=\"com.google.android.gms.ads.AdActivity\" android:configChanges=\"keyboard|keyboardHidden|orientation|screenLayout|uiMode|screenSize|smallestScreenSize\" /> \n");
          ...
          if (componentTypes.contains("ContactPicker")) {
          System.out.println("Write Contact");
          out.write("<uses-permission android:name=\"" + packageName + ".permission.READ_CONTACTS\" /> \n" +
                  " <uses-permission android:name=\"" + packageName + ".permission.WRITE_CONTACTS\" /> \n" );
	  }
