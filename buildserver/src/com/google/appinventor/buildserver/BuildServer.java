...
public class BuildServer {
  ...
  static class CommandLineOptions {
    ...
    int maxSimultaneousBuilds = 1;  // The default is unlimited.
  ...
  public Response var() throws IOException {
    ...
    variables.put("buildserver-version", "kkkk");
    variables.put("buildserver-git-fingerprint", "kkkk");
  ...
  public Response buildAllFromZipFileAsync(
    ...
    if (inputZip.length() == 0L) {
      ...
      if (gitBuildVersion != null && !gitBuildVersion.isEmpty()) {
        if (!gitBuildVersion.equals("kkkk")) {
          ...
          String errorMessage = "Build server version " + "kkkk" +
  ...
  public static void main(String[] args) throws IOException {
    ...
    LOG.info("App Inventor Build Server - Version: " + "kkkk");
    LOG.info("App Inventor Build Server - Git Fingerprint: " + "kkkk");
